  ...
  <UPageHero :ui="{
    ...
    <template #headline>
      <Motion :initial="{
        ...
        <NuxtImg class="size-18 rounded-full ring ring-default ring-offset-3 ring-offset-(--ui-bg)"
          :src="global.picture?.light!" :alt="global.picture?.alt!" width="144" height="144" format="webp" quality="100"
          loading="eager" />
      </Motion>
    </template>
